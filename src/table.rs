...
impl SsTable {
        ...
        let block_meta_offset =
            ...
            block_meta.iter().all(|meta| {
                meta.offset
                    ...
                    .is_some_and(|end| end < block_meta_offset)
            }),
    ...
    pub fn read_block(&self, block_idx: usize) -> Result<Arc<Block>> {
        ...
        let block_data_with_checksum = self.file.read(offset as u64, range_len as u64)?;
        let block_data = &block_data_with_checksum[..block_len];
        let checksum = u32::from_be_bytes([
            block_data_with_checksum[block_len],
            block_data_with_checksum[block_len + 1],
            block_data_with_checksum[block_len + 2],
            block_data_with_checksum[block_len + 3],
        ]);
